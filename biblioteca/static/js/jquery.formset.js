    ...
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            hasChildElements = function(row) {
                return row.find('input,select,textarea,label,*[contenteditable=true]').length > 0;
            },
                ...
                row.find('a.' + options.deleteCssClass).click(function() {
                    ...
                    if (del.length) {
                        ...
                        for (var i=0, formCount=forms.length; i<formCount; i++) {
                            ...
                            forms.eq(i).find('input,select,textarea,label,*[contenteditable=true]').each(function() {
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                template.find('input,select,textarea,label,*[contenteditable=true]').each(function() {
            ...
            addButton.click(function() {
                ...
                row.find('input,select,textarea,label,*[contenteditable=true]').each(function() {
